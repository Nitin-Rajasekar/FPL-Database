...
INSERT INTO `ACTIVATES` VALUES ('Team 4',1,'Triple Captain',107),('Team Bob',1,'NULL',85);
...
INSERT INTO `ADD_POINTS1` VALUES ('Team 4',1,'Ali Dia','Leeds United','Southampton',7),('Team 4',1,'Benjailmin Mendy','Manchester City','Liverpool',2),('Team 4',1,'Donny van de Beek','Newcastle United','Manchester United',0),('Team 4',1,'Eric Dier','Tottenham Hotspurs','Crystal Palace',1),('Team 4',1,'Erling Braut Haaland','Newcastle United','Manchester United',17),('Team 4',1,'Fred','Newcastle United','Manchester United',-3),('Team 4',1,'Guilty Sigurdsson','Everton','Brentford',0),('Team 4',1,'Harry Maguire','Newcastle United','Manchester United',-7),('Team 4',1,'Jonjo Shelvey','Newcastle United','Manchester United',12),('Team 4',1,'Kepa Arrizabalaga','Chelsea','Burnley',8),('Team 4',1,'Kylian Mbappe','Newcastle United','Manchester United',20),('Team 4',1,'Lionel Messi','Norwich City','Arsenal',48),('Team 4',1,'Nick Pope','Chelsea','Burnley',0),('Team 4',1,'Teemu Pukki','Norwich City','Arsenal',0),('Team 4',1,'Timo Werner','Chelsea','Burnley',2),('Team Bob',1,'Benjailmin Mendy','Manchester City','Liverpool',2),('Team Bob',1,'Christian Pulisic','Chelsea','Burnley',3),('Team Bob',1,'Donny van de Beek','Newcastle United','Manchester United',0),('Team Bob',1,'Eric Dier','Tottenham Hotspurs','Crystal Palace',1),('Team Bob',1,'Erling Braut Haaland','Newcastle United','Manchester United',17),('Team Bob',1,'Fred','Newcastle United','Manchester United',-3),('Team Bob',1,'Gabriel Jesus','Manchester City','Liverpool',0),('Team Bob',1,'Guilty Sigurdsson','Everton','Brentford',0),('Team Bob',1,'Jonjo Shelvey','Newcastle United','Manchester United',24),('Team Bob',1,'Kepa Arrizabalaga','Chelsea','Burnley',8),('Team Bob',1,'Marcos Alonso','Chelsea','Burnley',10),('Team Bob',1,'Michail Antonio','West Ham United','Brighton',10),('Team Bob',1,'Nick Pope','Chelsea','Burnley',0),('Team Bob',1,'Richarlison','Everton','Brentford',11),('Team Bob',1,'Timo Werner','Chelsea','Burnley',2);
...
INSERT INTO `ADD_POINTS2` VALUES ('Ali Dia','Leeds United','Southampton',7),('Benjailmin Mendy','Manchester City','Liverpool',2),('Donny van de Beek','Newcastle United','Manchester United',0),('Eric Dier','Tottenham Hotspurs','Crystal Palace',1),('Erling Braut Haaland','Newcastle United','Manchester United',17),('Fred','Newcastle United','Manchester United',-3),('Gabriel Jesus','Manchester City','Liverpool',13),('Guilty Sigurdsson','Everton','Brentford',2),('Harry Maguire','Newcastle United','Manchester United',-7),('Jonjo Shelvey','Newcastle United','Manchester United',12),('Kepa Arrizabalaga','Chelsea','Burnley',8),('Kylian Mbappe','Newcastle United','Manchester United',20),('Lionel Messi','Norwich City','Arsenal',16),('MArcos Alonso','Chelsea','Burnley',10),('Nick Pope','Chelsea','Burnley',12),('Richarlison','Everton','Brentford',11),('Teemu Pukki','Norwich City','Arsenal',10),('Timo Werner','Chelsea','Burnley',2);
...
INSERT INTO `CATEGORY` VALUES ('Barclays', 'Financial Services'),('Hublot', 'Accessories'),('Oracle', 'Computer and database services');
...
INSERT INTO `COMPETES` VALUES ('Team 4','ix8kt4',1),('Team 4','q5yps0',1),('Team Bob','ix8kt4',2),('Team Bob','q5yps0',2);
...
INSERT INTO `DEFENDER` VALUES ('Benjailmin Mendy',8,2,3),('Eric Dier',12,9,8),('Harry Maguire',2,1,1),('Marcos Alonso',5,13,7);
...
INSERT INTO `EDITION` VALUES (2022,,),(2021,Manchester City, Manchester United),(2020,Liverpool,Manchester City),(2010,Manchester City,Liverpool),(2018,Manchester City,Manchester United);
...
INSERT INTO `FORWARD` VALUES ('Ali Dia',1,0,0),('Erling Braut Haaland',3,17,2),('Gabriel Jesus',2,34,4),('Jamie Vardy',3,25,1),('Kylian Mbappe',2,36,3),('Michail Antonio',2,21,1),('Richarlison',2,29,3),('Teemu Pukki',1,9,0),('Timo Werner',0,15,5);
...
INSERT INTO `HAS_ACTIVE` VALUES ('Team 4','Bench Boost'),('Team Bob','Bench Boost'),('Team 4','Freehit'),('Team Bob','Freehit'),('Team Bob','Triple Captain'),('Team 4','Wildcard'),('Team Bob','Wildcard');
...
INSERT INTO `HEAD_TO_HEAD` VALUES ('Team Bob','Team 4','q5yps0','85 - 107');
...
INSERT INTO `KEEPER` VALUES ('Kepa Arrizabalaga',4,1,1),('Nick Pope',8,0,0);
/*!40000 ALTER TABLE `KEEPER` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KINGS_OF_THE_GAMEWEEK`
--

DROP TABLE IF EXISTS `KINGS_OF_THE_GAMEWEEK`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `KINGS_OF_THE_GAMEWEEK` (
  `Player_name` varchar(100) NOT NULL,
  `Week_number` int NOT NULL,
  `Points` int DEFAULT NULL,
  PRIMARY KEY (`Player_name`,`Week_number`),
  KEY `Week_number` (`Week_number`),
  CONSTRAINT `KINGS_OF_THE_GAMEWEEK_ibfk_1` FOREIGN KEY (`Player_name`) REFERENCES `PLAYER` (`Name`),
  CONSTRAINT `KINGS_OF_THE_GAMEWEEK_ibfk_2` FOREIGN KEY (`Week_number`) REFERENCES `GAMEWEEK` (`Week_number`),
  CONSTRAINT `KINGS_OF_THE_GAMEWEEK_chk_1` CHECK ((`Week_number` <= 38))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KINGS_OF_THE_GAMEWEEK`
--

LOCK TABLES `KINGS_OF_THE_GAMEWEEK` WRITE;
/*!40000 ALTER TABLE `KINGS_OF_THE_GAMEWEEK` DISABLE KEYS */;
INSERT INTO `KINGS_OF_THE_GAMEWEEK` VALUES ('Erling Braut Haaland',1,17),('Gabriel Jesus',1,13),('Jonjo Shelvey',1,12),('Kylian Mbappe',1,20),('Lionel Messi',1,16),('Nick Pope',1,12),('Richarlison',1,11);
/*!40000 ALTER TABLE `KINGS_OF_THE_GAMEWEEK` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `LEAGUE` VALUES ('ix8kt4','Relegation 100',2),('q5yps0','Justice League',2);
...
INSERT INTO `MIDFIELDER` VALUES ('Christian Pulisic',74,2,3),('Donny van de Beek',88,2,0),('Fred',92,1,0),('Guilty Sigurdsson',79,2,2),('Jonjo Shelvey',93,6,7),('Lionel Messi',100,12,8);
...
INSERT INTO `PARTNER1` VALUES ('Barclays', 'London'),('Hublot', 'Nyon'),('Oracle', 'Austin');
...
INSERT INTO `PARTNER2` VALUES ('London', 'United Kingdom'),('Nyon', 'Switzerland'),('Austin', 'United States of America');
...
CREATE TABLE `PLAYER` (
  ...
  `Selection %` decimal(5,2) DEFAULT NULL,
...
INSERT INTO `PLAYER` VALUES ('Ali Dia','Southampton',4.50,NULL,7,50.00,'Fit'),('Benjailmin Mendy','Manchester City',8.20,NULL,2,100.00,'Fit'),('Christian Pulisic','Chelsea',12.00,NULL,3,0.00,'Fit'),('Donny van de Beek','Manchester United',5.00,NULL,0,100.00,'Fit'),('Eric Dier','Tottenham Hotspurs',7.00,NULL,1,100.00,'Fit'),('Erling Braut Haaland','Newcastle United',12.50,NULL,17,100.00,'Fit'),('Fred','Manchester United',8.00,NULL,-3,100.00,'Injured'),('Gabriel Jesus','Manchester City',12.00,NULL,13,50.00,'Fit'),('Guilty Sigurdsson','Everton',6.90,NULL,2,100.00,'Suspended'),('Harry Maguire','Manchester United',7.50,NULL,-7,50.00,'Suspended'),('Jamie Vardy','Leicester City',11.30,NULL,9,0.00,'Fit'),('Jonjo Shelvey','Newcastle United',6.00,NULL,12,100.00,'Fit'),('Kepa Arrizabalaga','Chelsea',6.50,NULL,8,100.00,'Fit'),('Kylian Mbappe','Newcastle United',14.00,NULL,20,50.00,'Fit'),('Lionel Messi','Arsenal',17.00,NULL,16,50.00,'Fit'),('Marcos Alonso','Chelsea',9.00,NULL,10,50.00,'Fit'),('Michail Antonio','West Ham United',12.00,NULL,10,0.00,'Fit'),('Nick Pope','Burnley',4.50,NULL,12,100.00,'Fit'),('Richarlison','Everton',11.50,NULL,11,50.00,'Fit'),('Teemu Pukki','Norwich City',7.50,NULL,10,50.00,'Fit'),('Timo Werner','Chelsea',10.50,NULL,2,100.00,'Fit');
...
INSERT INTO `PLAYS_IN` VALUES ('Ali Dia','Leeds United','Southampton',1,7),('Benjailmin Mendy','Manchester City','Liverpool',1,2),('Christian Pulisic','Chelsea','Burnley',1,3),('Donny van de Beek','Newcastle United','Manchester United',1,0),('Eric Dier','Tottenham Hotspurs','Crystal Palace',1,1),('Erling Braut Haaland','Newcastle United','Manchester United',1,17),('Fred','Newcastle United','Manchester United',1,-3),('Gabriel Jesus','Manchester City','Liverpool',1,13),('Guilty Sigurdsson','Everton','Brentford',1,2),('Harry Maguire','Newcastle United','Manchester United',1,-7),('Jamie Vardy','Aston Villa','Leicester City',1,9),('Jonjo Shelvey','Newcastle United','Manchester United',1,12),('Kepa Arrizabalaga','Chelsea','Burnley',1,8),('Kylian Mbappe','Newcastle United','Manchester United',1,20),('Lionel Messi','Norwich City','Arsenal',1,16),('Marcos Alonso','Chelsea','Burnley',1,10),('Michail Antonio','West Ham United','Brighton',1,10),('Nick Pope','Chelsea','Burnley',1,12),('Richarlison','Everton','Brentford',1,11),('Teemu Pukki','Norwich City','Arsenal',1,10),('Timo Werner','Chelsea','Burnley',1,2);
...
INSERT INTO `SPONSORS` VALUES ('Barclays', '2022'),('Barclays', '2021'),('Barclays', '2020'),('Hublot', '2022'),('Hublot', '2021'),('Oracle', '2022');
...
INSERT INTO `TEAM` VALUES ('Team 4','DNA','Monsoon','India',107,98.50,1,1.50),('Team Bob','Bob','Spring','India',96,96.00,1,4.00);
...
INSERT INTO `TYPE` VALUES ('ix8kt4','Classic'),('ix8kt4','Invitational'),('q5yps0','Head-to-Head'),('q5yps0','Public');
...
-- Dump completed on 2021-10-23 23:51:08
