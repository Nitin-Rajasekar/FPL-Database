...
INSERT INTO `FORWARD` VALUES ('Erling Braut Haaland',3.4,17.1,2.1),('Jamie Vardy',2.5,15.2,0.9),('Kylian Mbappe',1.8,15.7,3.4),('Teemu Pukki',0.7,5.4,0.4),('Richarlison',1.9,8.8,2.5),('Michail Antonio',1.7,12.1,1.1),('Gabriel Jesus',2.1,14.4,3.8),('Ali Dia',1.4,0.1,0),('Lionel Messi',2.9,20.2,6.8),('Timo Werner',2.7,12.1,1.0);
